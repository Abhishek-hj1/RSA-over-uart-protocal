# Secure UART Communication Over RSA Encryption

This repository presents the complete design, implementation, and evaluation of a secure UART communication system utilizing RSA encryption. The project is developed using Verilog HDL and deployed on a Xilinx Spartan-3 FPGA platform. It integrates RSA key generation, encryption, and decryption modules with UART transmitter and receiver units to enable real-time encrypted serial communication.

The development workflow includes simulation, synthesis, and hardware validation based on the methodology described in the research paper titled "Design and Development of UART Communication Over RSA Encryption". This ensures a reliable and efficient implementation of secure UART communication on FPGA.

---
# Abstract
UART is a widely adopted communication interface in embedded and IoT systems due to its low complexity and minimal hardware requirements. However, as UART transmits data in an unencrypted format, it is prone to interception and unauthorized modification. To ensure secure data transfer, this project incorporates RSA-an asymmetric cryptographic algorithm-implemented entirely in hardware to secure UART communication.

The secure system architecture includes:
- Generation of RSA key pairs  
- Data encryption using the RSA algorithm  
- Plaintext recovery through RSA decryption  
- UART transmitter and receiver modules for serial communication  

This integration enables confidential serial data communication over UART.
<img width="1600" height="786" alt="image" src="https://github.com/user-attachments/assets/73bb5945-f7bd-46cd-92bc-6cbbf53d7b04" />
